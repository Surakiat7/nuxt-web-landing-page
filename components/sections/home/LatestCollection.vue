    ...
    <section class="pt-20 md:pt-24 relative">
        <AtomsContainer>
            <div class="flex justify-between items-center pb-6">
                <div class="">
                    <AtomsTitle texte="Latest Collection" />
                </div>
            ...
            <div class="relative">
                ...
                <div data-slide-recent @scroll="initScroll()"
                    ...
                    <div
                        ...
                        <CardsRecentEyeglasses title="FUWA CELLU (FC2028T-2SC4) is the perfect eyewear choice." duration="THB1,990.00" href="#"
                            cover-image="/images/eyeglasses/eyeglasses-2.webp" />
                    </div>

                    <div
                        class=" w-11/12 min-w-[91.666667%] xs:w-80 xs:min-w-[20rem] md:w-1/3 md:min-w-[33.333333%] lg:w-1/4 lg:min-w-[25%]">
                        <CardsRecentEyeglasses title="FUWA CELLU (FC2028T-2SC4) is the perfect eyewear choice." duration="THB1,990.00" href="#"
                            cover-image="/images/eyeglasses/eyeglasses-1.webp" />
                    </div>
